...
import {ArrowLeft,Star,GitFork,ExternalLink,Code2,Calendar,} from "lucide-react"
    ...
    if (!project) {
        return (
            <div className="flex min-h-[70vh] flex-col items-center justify-center p-6 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground"> We couldn't find this repository.</p>
                <Link
                    href="/projects"
        ...
        <div className="min-h-screen px-5 pb-10 lg:py-5">
            ...
            <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-2xl border border-emerald-400/20 bg-background p-5 transition hover:border-emerald-400/40 hover:shadow-[0_0_25px_rgba(16,185,129,0.08)]">
                    ...
                    <p className="text-2xl font-bold"> {project.stargazers_count}</p>
                </div>
                <div className="rounded-2xl border border-emerald-400/20 bg-background p-5 transition hover:border-emerald-400/40 hover:shadow-[0_0_25px_rgba(16,185,129,0.08)]">
                    <div className="mb-3 flex items-center gap-2 text-muted-foreground">
                    ...
                    <p className="text-2xl font-bold"> {project.forks_count} </p>
                </div>
                <div className="rounded-2xl border border-emerald-400/20 bg-background p-5 transition hover:border-emerald-400/40 hover:shadow-[0_0_25px_rgba(16,185,129,0.08)]">
                    <div className="mb-3 flex items-center gap-2 text-muted-foreground">
                    ...
                    <p className="text-lg font-semibold">{project.language || "Not specified"} </p>
                </div>
                <div className="rounded-2xl border border-emerald-400/20 bg-background p-5 transition hover:border-emerald-400/40 hover:shadow-[0_0_25px_rgba(16,185,129,0.08)]">
                    <div className="mb-3 flex items-center gap-2 text-muted-foreground">
            ...
            <section className="mb-6 rounded-2xl border border-emerald-400/20 bg-background p-6 transition hover:border-emerald-400/30">
                <div className="mb-4">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">Technologies used in this repository</p>
                </div>
                {project.language ? (
