    ...
    return (
        <section className="relative mx-auto max-w-7xl px-6 py-28">
            ...
            <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400"> Everything developers need to build, track and showcase their work.</p>
            </div>
...
function Card({
    ...
    return (
        <div
            className=" group relative overflow-hidden rounded-3xl border border-slate-200 dark:border-white/10 bg-white/70 dark:bg-slate-900/70
            backdrop-blur-xl p-8 transition-all duration-300 hover:-translate-y-2 hover:border-emerald-400/40 hover:shadow-[0_0_50px_rgba(16,185,129,0.18)]"
        >
            <div
                className=" absolute inset-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100
                bg-linear-to-br from-emerald-500/5 via-transparent to-emerald-400/5"
            />
            <div className="relative">
                <div
                    className="flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-emerald-400/20 to-emerald-600/10
                    text-emerald-400 ring-1 ring-emerald-500/20 transition-transform duration-300 group-hover:scale-110"
                >
                    {icon}
                </div>
                <h3 className="mt-8 text-2xl font-bold text-slate-900 dark:text-white">{title} </h3>
                <p className="mt-4 leading-7 text-slate-600 dark:text-slate-400">{description}</p>
            </div>
        </div>
    )
}