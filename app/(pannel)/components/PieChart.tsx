...
export function ChartPie() {
    ...
    return (
        <div
            className="
                relative my-10 h-140 w-full overflow-hidden rounded-3xl
                border border-emerald-400/40 p-7
            ...
            {isLoading ? (
                ...
                <div className="flex h-105 flex-col items-center justify-center text-center">
                    ...
                    <p className="mt-2 max-w-sm text-sm text-muted-foreground">
                        We couldn't load your repository data. Please try again
                        later.
                    </p>
                </div>
            ) : chartData.length === 0 ? (
                <div className="flex h-105 flex-col items-center justify-center text-center">
                    ...
                    <p className="mt-2 max-w-sm text-sm text-muted-foreground">
                        No programming languages were found in your repositories.
                    </p>
                </div>
            ) : (
                <ChartContainer
