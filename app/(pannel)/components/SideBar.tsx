...
function SideBar() {
  ...
  return (
    <aside className="hidden md:flex h-screen w-72 shrink-0 flex-col border-r border-zinc-200 bg-white dark:border-white/5 dark:bg-linear-to-b dark:from-[#0D1117] dark:to-[#090C10]">
